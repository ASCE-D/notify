        ...
        <div className="md:flex">
          <div className="md:w-1/2 p-6">
            ...
            <p className="text-gray text-lg">
              Say goodbye to missed doses and hello to a healthier, happier you. <br /> Welcome to Notify
            </p>
          </div>
          ...
          <div className="md:w-1/2 p-6">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <NavLink to="/login" className="underline decoration-sky-500 text-cyan-700">Login to Your Account</NavLink> {/* Replace anchor tag with NavLink */}
              </div>
              <br />
